...
inline bool isPossible(Board *board, Piece piece, Case caze, Couleur color)
{
	...
	{
	case CAVALIER:
		Cavalier(board, piece, caze, color);
		break;
	case TOUR:
		Tour(board, piece, caze, color);
		break;
	case FOU:
		Fou(board, piece, caze, color);
		break;
	case ROI:
		Roi(board, piece, caze, color);
		break;
	case PION:
		Pion(board, piece, caze, color);
		break;
	case REINE:
		Reine(board, piece, caze, color);
		break;
	default:
		return 0;
		break;
